...
def plot_spec(save=False):
	...
	fig = plt.figure()
	ax = fig.gca()
	sp.plot_spectrum(ax=ax,nuFnu=True,spec_therm=spec_therm,spec_synch=spec_synch)
	# sp.plot_spectrum(ax=ax,nuFnu=True,spec_therm=spec_therm)
	# sp.plot_spectrum(ax=ax,nuFnu=True,spec_synch=spec_synch)
