...
if __name__ == "__main__":
	...
	"""
	fn_spec = []
	fn_spec.append('files-data/synthetic-data/2023-09-07/synthGRB_spec_TOT_0.txt')
	fn_spec.append('files-data/synthetic-data/2023-09-07/synthGRB_spec_TOT_1.txt')
	...
	data_inst.load_light_curve(file_name = 'files-data/synthetic-data/2023-09-07/synthGRB_light_curve.txt')
	data_inst.load_spectrum(fn_spec[0],tstart[1],tend[0])
	data_inst.load_spectrum(fn_spec[1],tstart[0],tend[1])


	plot_lor_prof(file_name="files-data/synthetic-data/2023-09-07/synthGRB_shell_dist.txt")
	plot_light_curve(data_inst.light_curve)
	ax = plt.figure().gca()
	plot_data_spec(data_inst.spectra['SPECTRUM'][0],ax=ax,color=colors[0],spec_type=2,joined=True)
	plot_data_spec(data_inst.spectra['SPECTRUM'][1],ax=ax,color=colors[1],spec_type=2,joined=True)
	"""
