...
def plot_lor_dist(file_name,ax=None,save_pref=None,xlabel=True,ylabel=True,label=None,fontsize=14,fontweight='bold',marker='.', linestyle="solid",show_zoomed = False, separator_string = "// Next step\n"):
	"""
